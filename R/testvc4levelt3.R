...
# test the level 3 (innermost) for 4-level data. 
...
stato=statvc4levelt3(y,cluster,m1,n1,m2,n2,m3,n3,p,weight)
...
for(i in 1:npermut)
	...
	statp=statvc4levelt3(y,clusterperm,m1,n1,m2,n2,m3,n3,p,weight)
